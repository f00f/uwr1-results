...
print '<div id="side-info-column" class="inner-sidebar">'
	...
	. '<div id="misc-publishing-actions">'
		. '<div class="misc-pub-section misc-pub-section-last">'
			. '<a class="button" href="edit.php?page='.$_REQUEST['page'].'&action=edit_matchday_results&matchday_id='.$matchdayId.'">Ergebnisse des Spieltages bearbeiten</a>'
			. '<div class="clear"></div>'
		. '</div>'
		. '<div class="misc-pub-section misc-pub-section-last">'
...
//	. '<li><a href="'.Uwr1resultsView::resultsPageUrl($league).'">'.$league->shortName().' ansehen</a></li>'
	. '<li><a href="edit.php?page='.$_REQUEST['page'].'">Ergebnisse eintragen &mdash; Startseite</a></li>'
	. '</ul>'
	. '</div>'
	. '</div>';
*/
